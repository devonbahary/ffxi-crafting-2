...
export const synthesisProfits = pgTable(
    'synthesis_profits',
    {
        ...
        unitProfitAsSingle: integer('unit_profit_as_single').notNull(),
        unitProfitAsStack: integer('unit_profit_as_stack'),
        profitPerDayAsSingle: integer('profit_per_day_as_single'),
        profitPerDayAsStack: integer('profit_per_day_as_stack'),
        expectedUnitProfitAsSingleT0: integer('expected_unit_profit_as_single_t0').notNull(),
        expectedUnitProfitAsSingleT1: integer('expected_unit_profit_as_single_t1').notNull(),
        expectedUnitProfitAsSingleT2: integer('expected_unit_profit_as_single_t2').notNull(),
        expectedUnitProfitAsSingleT3: integer('expected_unit_profit_as_single_t3').notNull(),
        expectedUnitProfitAsStackT0: integer('expected_unit_profit_as_stack_t0'),
